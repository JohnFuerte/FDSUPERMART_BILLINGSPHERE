...
class DEntries extends StatefulWidget {
  ...
  @override
  State<DEntries> createState() => _DEntriesState();
}

class _DEntriesState extends State<DEntries> {
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownMenu<Item>(
                          ...
                          initialSelection: widget.item.firstWhere(
                              (e) => e.id == itemNameController.text),
                          enableSearch: true,

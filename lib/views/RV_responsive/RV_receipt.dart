...
class _ReceiptVoucherPrintState extends State<ReceiptVoucherPrint> {
  ...
  Future<void> fetchReceiptById() async {
    final receipt =
        await receiptVchService.fetchReceiptVchById(widget.receiptID);
  ...
  Future<Uint8List> _generatePdf(PdfPageFormat format, String title) async {
    ...
    //           .any((store) => store.code == receiptVch!.companyCode))
    //       .stores!
    //       .firstWhere((store) => store.code == receiptVch!.companyCode)
    //       .address;
    ...
    if (selectedComapny.isNotEmpty) {
      var company = selectedComapny.firstWhere(
      ...
      if (company != null) {
        ...
        var store = company.stores!.firstWhere(
          (store) => store.code == receiptVch!.companyCode,
          orElse: () => StoreModel(
            address: '',
            city: '',
            state: '',
    ...
    if (receiptVch != null && receiptVch!.entries.isNotEmpty) {
      var ledgerId = receiptVch!.entries.first.ledger;
      var ledgerId2 = receiptVch!.entries.last.ledger;
      ...
      ledgerBalance = fectedLedgers
          .firstWhere((ledger) => ledger.id == ledgerId)
          .debitBalance;
    }

    bool isChequeDetailsNotEmpty(chequeDetails) {
      if (chequeDetails == null) return false;

      return (chequeDetails.chequeNo?.isNotEmpty ?? false) ||
          (chequeDetails.chequeDate?.isNotEmpty ?? false) ||
          (chequeDetails.depositDate?.isNotEmpty ?? false) ||
          (chequeDetails.batchNo?.isNotEmpty ?? false) ||
          (chequeDetails.bank?.isNotEmpty ?? false) ||
          (chequeDetails.branch?.isNotEmpty ?? false);
    }
    ...
    double displayledgerBalance = ledgerBalance;
    pdf.addPage(
      pw.Page(
              ...
              pw.Container(
                ...
                child: pw.Container(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      pw.Text(
                        ' We thank you very much for your payment of Rs. ${receiptVch!.totalamount.toStringAsFixed(2)}',
                        style: pw.TextStyle(
                      ...
                      pw.Container(
                        width: 350,
                        child: pw.ListView(
                          children: receiptVch!.billwise.map(
                            (receipt) {
                              SalesEntry? sales = fectedSales.firstWhere(
                                (sales) => sales.id == receipt.purchase,
                              );
                              return pw.Table(
                                children: [
                                  pw.TableRow(
                      ...
                      pw.Container(
                        child: isChequeDetailsNotEmpty(
                                receiptVch?.chequeDetails)
                            ? pw.Column(
                                mainAxisAlignment: pw.MainAxisAlignment.start,
                                crossAxisAlignment: pw.CrossAxisAlignment.start,
                                children: [
                                  ...
                                  pw.Row(
                                    ...
                                    children: [
                                      ...
                                      pw.Container(
                                        width: 120,
                                        child: pw.Text(
                                          '${receiptVch!.chequeDetails!.chequeNo}',
                                          style: pw.TextStyle(
                                            fontSize: 8,
                                            fontWeight: pw.FontWeight.normal,
                                          ),
                                      ...
                                      pw.Container(
                                        width: 120,
                                        child: pw.Text(
                                          '${receiptVch!.chequeDetails!.chequeDate}',
                                          style: pw.TextStyle(
                                            fontSize: 8,
                                            fontWeight: pw.FontWeight.normal,
                                          ),
                                  ...
                                  pw.Row(
                                    ...
                                    children: [
                                      ...
                                      pw.Container(
                                        width: 120,
                                        child: pw.Text(
                                          '${receiptVch!.chequeDetails!.depositDate}',
                                          style: pw.TextStyle(
                                            fontSize: 8,
                                            fontWeight: pw.FontWeight.normal,
                                          ),
                                      ...
                                      pw.Container(
                                        width: 120,
                                        child: pw.Text(
                                          '${receiptVch!.chequeDetails!.batchNo}',
                                          style: pw.TextStyle(
                                            fontSize: 8,
                                            fontWeight: pw.FontWeight.normal,
                                          ),
                                  ...
                                  pw.Row(
                                    ...
                                    children: [
                                      ...
                                      pw.Container(
                                        width: 120,
                                        child: pw.Text(
                                          '${receiptVch!.chequeDetails!.branch}',
                                          style: pw.TextStyle(
                                            fontSize: 8,
                                            fontWeight: pw.FontWeight.normal,
                                          ),
                      ...
                      receiptVch!.narration!.isNotEmpty
                          ? pw.Container(
                              child: pw.Column(
                                mainAxisAlignment: pw.MainAxisAlignment.start,
                                crossAxisAlignment: pw.CrossAxisAlignment.start,
                  ...
                  children: [
                    pw.Container(
                      child: pw.Container(
                        ...
                        child: pw.Text(
                          'Rs.       ${receiptVch!.totalamount.toStringAsFixed(2)} ',
                          style: pw.TextStyle(
                            fontSize: 12,
                            fontWeight: pw.FontWeight.bold,
                            decoration: pw.TextDecoration.underline,
                        ...
                        children: [
                          ...
                          pw.Row(
                            ...
                            children: [
                              ...
                              pw.Container(
                                child: pw.Text(
                                  displayledgerBalance.toStringAsFixed(2),
                                  style: pw.TextStyle(
                                    fontSize: 8,
                                    fontWeight: pw.FontWeight.normal,

...
class _ReceiptVoucherHomeState extends State<ReceiptVoucherHome> {
  ...
  List<ReceiptVoucher> fetchedReceipt2 = [];
  ...
  void searchDate(String value) {
    setState(() {
      fetchedReceipt = fetchedReceipt2
          .where((receipt) =>
  ...
  void searchParticulars(String value) {
    setState(() {
      ...
      fetchedReceipt = fetchedReceipt2.where((receipt) {
    ...
    return isLoading
        ...
        : Scaffold(
            appBar: PreferredSize(
              ...
              child: AppBar(
                title: Text(
                  'List of Receipt Voucher Tablet',
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (context) => ReceiptVoucherPrint(
                                      ...
                                      receiptID: fetchedReceipt[index].id,
                                    ),
                                  ),
                                );
                              },

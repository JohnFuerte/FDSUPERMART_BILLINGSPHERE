...
import 'quick_entry_billwise_receipt.dart';

class QuickEntryReceipt extends StatefulWidget {
  const QuickEntryReceipt(
      {super.key,
      required this.lid,
  ...
  @override
  State<QuickEntryReceipt> createState() => _ChequeReturnEntryState();
}

class _ChequeReturnEntryState extends State<QuickEntryReceipt> {
  ...
  void initState() {
    ...
    _voucherTypeController.text = 'Receipt';
  ...
  void openDialog1(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => QuickEntryBillwiseReceipt(
